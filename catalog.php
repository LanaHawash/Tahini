        ...
        <ul class="nav-menu">
            ...
            <li class="dropdown">
                ...
                <div class="submenu" id="submenu">
                    <div class="media-card"><img src="img/sub1.png"><p>Tahini 1kg <span class="arrow">→</span></p></div>
                    ...
                    <div class="media-card"><img src="img/sub4.png"><p>Halva <span class="arrow">→</span></p></div>
                </div>
            </li>
            <li class="dropdown">
